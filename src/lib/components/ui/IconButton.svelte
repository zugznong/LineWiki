<script lang="ts">
  ...
  const variantStyles: Record<'ghost' | 'default' | 'accent', string> = {
    ghost: 'p-2 bg-transparent text-slate-400 hover:bg-slate-900/50 hover:text-slate-100',
    default: 'p-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 border border-slate-700/60 shadow',
